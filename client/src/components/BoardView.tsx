...
export const BoardView = () => {
    ...
    return (
        <div className="flex h-[calc(100vh-73px)] bg-[#f7f6f3]">
                ...
                >
                    <div className="flex gap-4 h-full">
                        {columns.map((column) => {
                            ...
                            return (
                                <div key={column._id} className="flex-shrink-0 w-80 h-full">
                                    <div className="bg-white rounded-lg border border-[#e9e9e7] shadow-sm p-4 h-full flex flex-col">
                                        {/* Column Header */}
                                        <div className="flex items-center justify-between mb-4 flex-shrink-0">
                                            <h3 className="text-base font-semibold text-[#37352f]">{column.title}</h3>
                                            <span className="bg-[#f1f1ef] text-[#787774] text-xs px-2.5 py-1 rounded-full font-medium">
                                                {columnCards.length}
                                            </span>
                                        </div>
                                        ...
                                        {column._id === firstColumnId && (
                                            <div className="flex-shrink-0 mt-3 pt-3 border-t border-[#e9e9e7]">
                                                {showAddCard === column._id ? (
                                                    <div className="space-y-2">
                                                        <input
                                                            ...
                                                            className="w-full px-3 py-2 border border-[#e9e9e7] rounded-md text-[#37352f] placeholder-[#9b9a97] outline-none focus:border-[#2383e2] focus:ring-1 focus:ring-[#2383e2] transition-all text-sm"
                                                            autoFocus
                                                            onKeyPress={(e) => {
                                                        ...
                                                        <textarea
                                                            ...
                                                            className="w-full px-3 py-2 border border-[#e9e9e7] rounded-md text-[#37352f] placeholder-[#9b9a97] outline-none focus:border-[#2383e2] focus:ring-1 focus:ring-[#2383e2] resize-none transition-all text-sm"
                                                            rows={2}
                                                        />
                                                        <div className="flex gap-2">
                                                            <button
                                                                onClick={() => handleAddCard(column._id)}
                                                                className="flex-1 bg-[#2383e2] text-white py-1.5 rounded-md hover:bg-[#1a73cf] transition-colors text-sm font-medium"
                                                            >
                                                                Add
                                                            </button>
                                                            <button
                                                                ...
                                                                className="flex-1 bg-[#f1f1ef] text-[#787774] py-1.5 rounded-md hover:bg-[#e9e9e7] transition-colors text-sm font-medium"
                                                            >
                                                                Cancel
                                                            </button>
                                                        </div>
                                                    ...
                                                    <button
                                                        ...
                                                        className="w-full bg-[#f7f6f3] text-[#787774] py-2 rounded-md hover:bg-[#f1f1ef] transition-colors flex items-center justify-center gap-2 text-sm font-medium border border-[#e9e9e7]"
                                                    >
